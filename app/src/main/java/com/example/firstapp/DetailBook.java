        ...
        if (existsCurrentlyReading) {
            ...
            currentlyReading.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Utils.getInstance(DetailBook.this).addToCurrentlyReadingBooks(book)) {
                        Toast.makeText(DetailBook.this, "Book Added", Toast.LENGTH_SHORT).show();
                        // TODO: Navigate the user
                        Intent intent = new Intent(DetailBook.this, CurrentlyReadingBook.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(DetailBook.this, "Error! Try Again", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void handleAlreadyRead(Book book) {
        ...
        if (existsInAlreadyRead) {
            ...
            finishedReading.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (Utils.getInstance(DetailBook.this).addToAlreadyReadBooks(book)) {
                        Toast.makeText(DetailBook.this, "Book Added", Toast.LENGTH_SHORT).show();
                        // TODO: Navigate the user
                        Intent intent = new Intent(DetailBook.this, AlreadyReadBook.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(DetailBook.this, "Error! Try Again", Toast.LENGTH_SHORT).show();
                    }
