...
import static com.example.firstapp.DetailBook.BOOK_ID_KEY;
...
//                Toast.makeText(context, books.get(position).getName() + " Selected", Toast.LENGTH_LONG).show();
        ...
        if(books.get(position).isExpanded()){
            ...
            } else if (context.getClass().equals(AlreadyReadBook.class)) {
            ...
            } else if (context.getClass().equals(CurrentlyReadingBook.class)) {
                holder.bookDeleteButton.setVisibility(View.VISIBLE);
                holder.bookDeleteButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
